...
Several embodied agents for game playing exist, such as the iCat chess tutor \cite{Affective2007} and the \gls{emys} Risk player \cite{Pereira}.%, nevertheless these scenarios were not applied to aged people.

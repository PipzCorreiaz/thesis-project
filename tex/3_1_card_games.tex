...
\gls{ismcts}    & \begin{tabular}[c]{@{}l@{}}Computation can be offline\\ Easy to parallel\\ Computational budget\end{tabular}                      & \begin{tabular}[c]{@{}l@{}}Strategy fusion (less than \gls{pimc})\\ Non-locality\end{tabular}                       \\ \hline
\gls{iimc}      & \begin{tabular}[c]{@{}l@{}}Computation can be offline\\ Easy to parallel\\ Allow a different player model per player\end{tabular} & \begin{tabular}[c]{@{}l@{}}Strategy fusion (less than \gls{pimc})\\ Non-locality\end{tabular} \\ \hline
\end{tabular}
}

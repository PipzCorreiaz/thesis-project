...
However, the last one can be used simultaneously as a complement. \todo{Find a better word! Complement sounds awful!}
The next three subsections will describe in more detail how this approaches can be addressed in hidden information games.

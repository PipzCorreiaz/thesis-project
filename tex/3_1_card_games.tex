...
The most used approach is determinization, which samples choice nodes instead of considering all of them in an information set.
Applying this approach to \gls{mcts} is known as \gls{pimc}.
For instance in a card game scenario, each iteration of the algorithm samples the cards distributions and the simulation process of the game behaves as a perfect information game.
...
In 1998, Frank and Basin procuded an analysis on \gls{pimc}'s limitations.

...
Cowling et. al. have invetigated the application of \gls{mcts} to hidden information games \cite{Cowling2012}.
Their reaserch supports a new descendent family of algorithms that will be further described in the current section.
The authors presented three different types of imperfect information games.
\begin{itemize}
\item \emph{Information sets} 
\item \emph{Partially obervable} 
\item \emph{Simultaneous moves} 
\end{itemize}

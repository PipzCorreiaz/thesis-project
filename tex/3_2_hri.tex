...
This autonomous robot's duties are to guide the elderly through their environment, and to remind them about their daily activities, such as eating or taking their medicine (Figure~\ref{fig:pearl}).
...
\emph{Paro} is considered a companion robot and is a seal shaped robot used as medical therapy for the elderly (Figure~\ref{fig:paro}).
...
\begin{figure}[h]
        ...
        \begin{subfigure}[h]{0.5\textwidth}
                ...
                \label{fig:emys}
        \end{subfigure}
        \caption{Companion robots in game playing scenarios.}\label{fig:elder-robots}
\end{figure}

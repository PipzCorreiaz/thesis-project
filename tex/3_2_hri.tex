...
Regarding the goals of this project, it is crucial to investigate and evaluate the state of the art of \gls{hri} related to our proposed embodied agent.
...
The greying of population is an undeniable demographic fact.
...
In spite of these limitations, robots can be useful in more specific tasks.
...
A well known social service robot is \emph{Pearl}, developed in the Carnegie Mellon University within the Nursebot Project \cite{Pollack2002}.
...
The aid these service type robots grant to elderly covers most of their daily basic activities.
...
Since 2003 the work of Wada et. al. have tried to evaluate psychological, physiological and social effects of \emph{Paro} on the residents of a care house \cite{Wada2003,Wada2005,Wada2007}.
...
Another example of a purely companion robot is the \emph{Huggable} \cite{Stiehl2005}, a teddy bear shaped that is covered of extremely sensitive touch sensors.
...
The authors suggest that a fault in a service robot might cause serious problems.
...
Considering the goals of the proposed robot, \emph{Aibo} is much more close to our goals than the other mentioned robots, due to its entertainment purpose.

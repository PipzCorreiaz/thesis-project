...
experiences,\todo{Check this work!}
...
For instance, contrasting with what was expected, the elderly do not feel unconfortable and disrespected with a robot calling the doctor and releaving inproper behaviours from its owner. \todo{check inproper!}
